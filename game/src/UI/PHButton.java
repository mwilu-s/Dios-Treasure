 ...
 * @author User
 */
public class PHButton extends PauseButton{
    ...
    /**
     *Creates the profile and help buttons
     ...
     */
    public PHButton(int x, int y, int width, int height, int rowIndex) {
    ...
    /**
     *loads the button images (help, profile)
     */
    public void loadImgs(){
        BufferedImage temp = LoadAndSave.getSprites(LoadAndSave.PHBTNS);
